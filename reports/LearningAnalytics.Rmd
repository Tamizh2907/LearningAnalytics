...
subtitle: "Exploratory Data Analysis on the cyber security course from FutureLearn"
...
From the 'Figure 2' plot regarding the age range, we cannot see any discrete differences in the block of age range across ages. Leave "Unknown" group aside. If they set the personal details entry as mandatory, we can fetch even more clear picture about the age range. They should create even more courses or tweak cyber security course according to the learners who represent majority of the age range.
...
```{r, echo = FALSE, fig.cap="Comparing number of people left the course with their reason for leaving"}
